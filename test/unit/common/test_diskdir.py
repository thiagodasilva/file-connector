...
""" Tests for file_connector.swift.common.DiskDir """
...
import file_connector.swift.common.DiskDir as dd
...
class TestContainerBroker(unittest.TestCase):
    ...
    def test_get_info(self):
        ...
        __save_config = \
            file_connector.swift.common.DiskDir._container_update_object_count
        file_connector.swift.common.DiskDir._container_update_object_count = \
            True
...
class TestAccountBroker(unittest.TestCase):
    ...
    def test_get_info(self):
        ...
        __save_config = \
            file_connector.swift.common.DiskDir._account_update_container_count
        file_connector.swift.common.DiskDir._account_update_container_count = \
            True
        broker = self._get_broker(account='test1')
        broker.initialize(self.initial_ts)
...
class TestDiskAccount(unittest.TestCase):
    """ Tests for file_connector.swift.common.DiskDir.DiskAccount """
